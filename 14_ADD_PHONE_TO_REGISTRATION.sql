-- ============================================================================
-- SCRIPT DE ACTUALIZACIÓN: REQUERIR NÚMERO DE TELÉFONO EN EL REGISTRO
-- Ejecuta este script en el editor SQL de Supabase para actualizar la base de datos.
-- ============================================================================

-- 1. Asegurar que las columnas de teléfono existen en las tablas profiles y company_settings
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS phone TEXT;
ALTER TABLE public.company_settings ADD COLUMN IF NOT EXISTS phone TEXT;

-- 2. Actualizar la función handle_new_user para registrar el teléfono en profiles y company_settings
...
BEGIN
  ...
  -- E. Perfil (Guardando el teléfono del registro)
  ...
  -- H. Configuraciones (Con el teléfono guardado para facturas y envíos)
  INSERT INTO public.company_settings (store_id, company_name, phone)
  VALUES (new_store_id, company_name_val, NEW.raw_user_meta_data ->> 'phone')
...
-- 3. Re-vincular el trigger en auth.users
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
CREATE TRIGGER on_auth_user_created
  AFTER INSERT ON auth.users
  FOR EACH ROW EXECUTE FUNCTION public.handle_new_user();

-- 4. Actualizar la función de autoreparación auto_repair_profile para que también recupere el teléfono
...
BEGIN
  ...
  SELECT email, raw_user_meta_data ->> 'full_name', raw_user_meta_data ->> 'company_name', raw_user_meta_data ->> 'shop_type', raw_user_meta_data ->> 'phone'
    INTO v_user_email, v_user_name, v_company_name, v_shop_type, v_phone
    FROM auth.users
   WHERE id = v_user_id;
  ...
  INSERT INTO public.company_settings (store_id, company_name, phone)
  VALUES (v_new_store_id, v_company_name, v_phone)
  ON CONFLICT (store_id) DO UPDATE
    SET phone = COALESCE(company_settings.phone, EXCLUDED.phone);
