...
<body>
  <div class="invoice-container">
    ...
    <div style="background-color: #ffffff; border: 2px solid #000000; border-radius: 6px; padding: 8px 10px; margin-bottom: 8px;">
      ...
      <div style="display: flex; justify-content: space-between; font-size: ${sizeSmall}px; color: #000000; font-weight: 800; margin-bottom: 4px;">
    ...
    <div style="background-color: #ffffff; border: 2px solid #000000; border-radius: 6px; padding: 8px 10px; margin-bottom: 8px;">
      ...
      <div style="display: flex; justify-content: space-between; font-size: ${sizeSmall}px; color: #000000; font-weight: 800; margin-top: 4px;">
        <span>Monto Recibido:</span>
        <span style="font-family: 'JetBrains Mono', monospace; font-weight: 900; color: #000000;">${invoiceData.currency} ${fmt(invoiceData.amountPaid !== undefined && invoiceData.amountPaid > 0 ? invoiceData.amountPaid : invoiceData.total)}</span>
      </div>

      <div style="display: flex; justify-content: space-between; align-items: center; font-size: ${sizeSmall}px; color: #000000; font-weight: 800; margin-top: 3px;">
        <span>Devuelta:</span>
        <span style="font-family: 'JetBrains Mono', monospace; font-weight: 900; color: #000000; background-color: #ffffff; border: 1.5px solid #000000; padding: 1px 6px; border-radius: 4px;">
    ...
    ${(invoiceData.loyaltyPointsEarned !== undefined || invoiceData.loyaltyPoints !== undefined) ? `
      <div style="border-top: 2px dashed #000000; margin-top: 8px; padding-top: 6px; text-align: center;">
        <div style="font-size: ${sizeSmall}px; font-weight: 900; color: #000000; margin-bottom: 2px;">★ PUNTOS DE LEALTAD ★</div>
        ${invoiceData.loyaltyPointsEarned !== undefined && invoiceData.loyaltyPointsEarned > 0 ? `
          <div style="font-size: ${sizeSmall}px; margin-bottom: 1px; color: #000000; font-weight: 800;">
            Ganados esta compra: <strong style="color: #000000; font-weight: 900;">+${invoiceData.loyaltyPointsEarned} pts</strong>
          </div>
        ` : ''}
        ${invoiceData.loyaltyPoints !== undefined ? `
          <div style="font-size: ${sizeSmall}px; color: #000000; font-weight: 800;">
            Saldo total: <strong style="color: #000000; font-weight: 900;">${invoiceData.loyaltyPoints} pts</strong>
          </div>
        ` : ''}
      </div>
    ` : ''}
    ...
    <div style="border-top: 2px solid #000000; padding-top: 10px; margin-top: 8px; text-align: center;">
      ${invoiceData.showBarcode && invoiceData.barcodeDataUrl && !invoiceData.isElectronic ? `
        <div style="margin-bottom: 8px; text-align: center;">
          ...
          <div style="font-family: 'JetBrains Mono', 'SF Mono', monospace; font-size: 13px; font-weight: 900; color: #000000; margin-top: 4px; letter-spacing: 1.5px;">${displayNCF}</div>
        </div>
      ` : ''}
      ...
      ${invoiceData.isElectronic && invoiceData.qrCodeUrl ? `
        <div style="text-align: center; margin-bottom: 8px;">
          ...
          <div style="font-size: 9px; text-align: left; margin: 6px auto 0 auto; width: fit-content; font-family: 'JetBrains Mono', monospace; line-height: 1.35; color: #000000; font-weight: 800;">
          ...
          <div style="font-size: 8px; font-weight: 900; color: #000000; margin-top: 4px; text-transform: uppercase; letter-spacing: 0.5px;">Comprobante Autorizado por la DGII</div>
        </div>
      ` : ''}
      
      <div style="font-weight: 900; font-size: ${sizeSmall}px; color: #000000; text-transform: uppercase; letter-spacing: 0.4px; margin-top: 4px;">
        ¡GRACIAS POR SU COMPRA!
      </div>
      
      ${invoiceData.footerText ? `
        <div style="font-size: ${sizeXSmall}px; color: #000000; font-weight: 700; margin-top: 3px; padding: 0 4px;">
          ${invoiceData.footerText}
        </div>
      ` : ''}
      ...
      <div style="margin-top: 14px; padding-top: 10px; border-top: 2px dashed #000000; display: flex; justify-content: center; align-items: center; gap: 8px;">
        ...
        <span style="font-size: 15px; font-weight: 900; color: #000000; text-transform: uppercase; letter-spacing: 2px; font-family: 'Inter', -apple-system, sans-serif;">
          COBROAPP
        </span>
      </div>
    </div>
