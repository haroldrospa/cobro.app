-- =========================================================================
-- OPTIMIZACIÓN: Facturación atómica en un único viaje de red (1 roundtrip)
-- ACTUALIZACIÓN: Cambiar p_invoice_type_id de UUID a TEXT
-- Ejecuta este script en el editor de SQL de Supabase (https://supabase.com)
-- =========================================================================

-- 1. Eliminar la versión anterior con parámetro UUID para evitar duplicados / firmas conflictivas
...
-- 2. Crear la función con el parámetro p_invoice_type_id de tipo TEXT
CREATE OR REPLACE FUNCTION public.create_sale_transaction_v3(
  p_sale_id UUID,
  p_customer_id UUID,
  p_invoice_type_id TEXT, -- Cambiado de UUID a TEXT para soportar códigos como 'B01', 'B02'
  p_subtotal NUMERIC,
